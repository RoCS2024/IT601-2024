...
import com.polymorphism.reserve.facility.auditorium.Auditorium;
import com.polymorphism.reserve.facility.gym.Gym;
import com.polymorphism.reserve.facility.laboratory.Laboratory;
public class Main {


        public static void main(String[]args){
            Facility audi = new Auditorium();
            Facility gym = new Gym();
            Facility laboratory = new Laboratory();
            int run = 1;
            int event = 0;
            int choice;
