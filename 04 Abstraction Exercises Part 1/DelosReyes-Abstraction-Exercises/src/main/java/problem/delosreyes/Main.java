...
public class Main {
    public static void main(String[] args) {
        ...
        if (choice == 1 ) {
            System.out.println("Area of the Rectangle is: " + newRectangle.calculateArea() + " meter");
            System.out.println("Perimeter of the Rectangle is: " + newRectangle.calculatePerimeter() + "meter");
        } else if (choice == 2) {
